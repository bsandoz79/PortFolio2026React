    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.socials}>
          <a href="https://github.com/bsandoz79" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/baptiste-sandoz" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="LinkedIn">
